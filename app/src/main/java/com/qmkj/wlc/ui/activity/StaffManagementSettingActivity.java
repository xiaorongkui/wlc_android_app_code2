...
public class StaffManagementSettingActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        staffRecycle.setLayoutManager(layoutManager);
        staffRecycle.setAdapter(staffAdapter);
        staffRecycle.addItemDecoration(new DividerItemDecoration(this,DividerItemDecoration.VERTICAL));
        ...
        //设置滑动监听
        staffRecycle.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
